            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or opt.save_crop or view_img:  # Add bbox to image
                        ...
                        distancei = (2 * 31.4 * 180) / (width + height) * 100
                        label2 = f'{names[int(cls)]} {distancei:.1f}cm'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--iou-thres', type=float, default=0.80, help='IOU threshold for NMS')
